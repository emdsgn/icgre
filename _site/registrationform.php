...
If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@icgre.org. You can find the copyright form here: www.icgre.org/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
<div id="content">
  ...
  <header>
	...
	<div class="cbp-af-inner">
        ...
        <div class="bg">
          <h1>2<sup>nd</sup> International Conference on Geotechnical<br>Research and Engineering (ICGRE'17)</h1>
...
<p class="body" style="text-align:center!important;">ICGRE'17 is part of the <b>2<sup>nd</sup> World Congress on Civil, Structural, and Environmental Engineering (CSEE'17)</b>. For more information about the congress, please visit the website here: <a href="http://cseecongress.com/" class="body-link">www.cseecongress.com</a>.</p>
...
<p class="body" style="text-align:center!important; color: #FFF!important;">ICGRE'17 is part of the <b>2<sup>nd</sup> World Congress on Civil, Structural, and Environmental Engineering (CSEE'17)</b>.<br>For more information about the congress, please visit the website here: <a href="http://cseecongress.com/" class="body-link">www.cseecongress.com</a>.</p>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      ...
      <p class="body">ICGRE 2017 will  be held in Barcelona, Spain on April 2 - 4, 2017 at the Alimara Hotel Barcelona.</p>
	...
	<div>
      ...
      <p class="body">ICGRE attracts a wide range of researchers in the field of geotechnical research and engineering. As a prominent company in the field of geotechnical research and engineering, we would like to offer you an exhibit at ICGRE. Please visit <a href="../events" class="body-link">Events</a> for more information.</p>
    </div>
  </div>
    </div>
  </div>
  ...
  <div class="unit-spacer content">
    ...
    <p class="body">If you do not receive an email, <strong>please check your SPAM folder</strong>.</p>
 	...
 	<p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
  	...
  	<p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@icgre.org" class="body-link">registration@icgre.org</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

	<p class="body">We are looking forward to seeing you at ICGRE'17!</p>
  </div>
</div>
...
<footer id="contact">
	...
	<div class="unit-spacer">
	<p class="body">For questions or comments regarding ICGRE'17, please fill out the form below:</p>
